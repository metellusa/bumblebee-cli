...
class SourceCodeService {
    ...
    static async generateDatabaseAdapter(verb, directory, parameters) {
        ...
        classImports.add(`import { ${imports_const_1.RESORT_AREA_CODE} } from "${path_1.default.relative(project_const_1.DATABASE_ADAPTERS_DIR, project_const_1.RESORT_AREA_CODE_ENUM_PATH.replace(".ts", "")).replace(/\\/g, "/")}";`);
