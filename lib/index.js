...
function runBumblebeeCli() {
    ...
    inquirer_1.default.prompt([
        ...
        const submitSwaggerResponse = await actions_service_1.default.submitSwagger(swaggerPath);
        const paths = [];
        ...
        if (initialPromptAnswers.functionChoice.includes("Validate")) {
            const pathsValidationErrorsMap = await validation_service_1.default.validateSwagger(swaggerPath);
            ...
            inquirer_1.default.prompt([
                ...
                const generatedFiles = await configuration_service_1.default.generateProjectFiles(swaggerPath, targetLocation, swagger.repoName, swagger.repoDescription);
