...
class ActionsService {
    ...
    static async submitSwagger(filePath) {
        if (fs_1.default.existsSync(filePath)) {
            ...
            const repoName = case_1.default.kebab(common_utils_1.default.getField(this.inputYaml.info, "title").replace("API", ""));
            // Infer the repo description from the swagger
            const repoDescription = common_utils_1.default.getField(this.inputYaml.info, "description");
            let paths = [];
